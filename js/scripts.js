$(document).ready(function () {
    ...
    $.i18n().load({
        'en': {
            ...
            'map-subheader': 'It\'s way easier than you think!',
            'map-show': 'Show map',
            ...
            'event-dresscode': 'Guests can wear something formal, bright & vivid.',
        ...
        'fr': {
            ...
            'event-dresscode': 'Les invités doivent porter des habits formels, de préférence colorés et d\'inspiration estivale. Pas de chaussures à bouts carrés, c\'est interdit',
