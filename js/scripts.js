$(document).ready(function () {
    ...
    $.i18n().load({
        'en': {
            ...
            'event-e3-desc': 'Following the ceremony, we will have a small reception with photos and drinks.',
        ...
        'fr': {
            ...
            'event-e3-header': 'Garden Reception ',
            'event-e3-desc': 'Suivant la cérémonie, nous aurons une petite récéption avec photos et boissons.',
