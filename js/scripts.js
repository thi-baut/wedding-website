$(document).ready(function () {
    ...
    $.i18n().load({
        ...
        'fr': {
            ...
            'intro-s4': 'La cérémonie sera au Canada, en Ontario, dans le comté de Prince Edward. S\'il vous plaît repondez avant le 1er février 2022.',
            ...
            'intro-s10': 'et le',
            'intro-s11': 'Il y a plusieurs Airbnb et des petits hôtels dans la région. Plus de détails à propos du service de navette depuis le lieu de cérémonie seront fournis lorsque nous serons proches de la date du mariage.',
            'eng-header': 'Photos',
