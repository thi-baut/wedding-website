$(document).ready(function () {
    ...
    $.i18n().load({
        'en': {
            ...
            'intro-s5': 'Canada welcomes fully vaccinated travellers with no quarantine. Latest guidelines are available on ',
            ...
            'event-e1-header': 'Guests Arrival',
            'event-e1-desc': 'Please arrive no later than 3:30PM at Lake on the Mountain. Parking is available on site. ',
            ...
            'event-e3-desc': 'Following the ceremony, we will have a small reception with photos, drinks and speeches.',
        ...
        'fr': {
            ...
            'intro-s5': 'Le Canada accueille les voyageurs étrangers vaccinés (3 doses) qui présentent leurs preuve de vaccination. Les consignes sont publiées et mises à jour sur ',
            ...
            'event-e1-header': 'Arrivée des invités',
            'event-e1-desc': 'Svp arrivez au plus tard à 3:30 PM à Lake on The Mountain, un stationement sera disponible sur place. ',
            ...
            'event-e3-header': 'Garden Reception',
            'event-e3-desc': 'Suivant la cérémonie, nous aurons une petite récéption avec discours, photos et boissons.',
