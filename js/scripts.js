$(document).ready(function () {
    ...
    $.i18n().load({
        'en': {
            ...
            'intro-s4': 'The ceremony will be in Prince Edward County, Ontario, Canada. Please RSVP before the',
            'intro-s4-2': ' 1st of February \'22.',
        ...
        'fr': {
            ...
            'intro-s4': 'La cérémonie sera au Canada, en Ontario, dans le comté de Prince Edward. S\'il vous plaît repondez avant le',
            'intro-s4-2': ' 1er février 2022.',
            'intro-s5': 'En date du 27 novembre 2021, le Canada accueille les voyageurs étrangers vaccinés (2 doses) qui présentent leurs preuve de vaccination et un test PCR récent. Les consignes sont publiées et mises à jour sur ',
