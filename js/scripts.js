$(document).ready(function () {
    ...
    $.i18n().load({
        'en': {
            ...
            'intro-s4': 'The ceremony will be in Prince Edward County, Ontario, Canada. Please RSVP before the 1st of February \'22.',
            ...
            'intro-s10': 'and the',
            'intro-s11': 'There are also many airbnbs and boutique hotels in the area - we encourage you to explore! Further details regarding shuttle service to and from the venue will be provided closer to the date.',
            'eng-header': 'Pictures',
        ...
        'fr': {
            ...
            'intro-s7': 'Il y a plusieurs options d\'hébergement dans le conté de Prince Edward. Un hébergement peut être réservé dans le complexe adjascent ',
            ...
            'rsvp-sentence': 'Nous serions très reconnaissants si vous répondiez avant le 1er Février 2022 en utilisant le formulaire ci-dessous.',
            'rsvp-questions': 'Si vous avez des questions svp envoyez nous un courriel à ',
            'list-s1': 'Nous n\'avons de liste officielle, nous prévoyons de faire un voyage après notre marriage.',
            'list-s2': 'Nous voudrions recevoir vos donations par eTransfer (Interac) à lillian.thibaut@gmail.com ou en liquide ($ ou €) sur place.',
            ...
            'event-dresscode-header': 'Erf, dress code?',
            'event-dresscode': 'Les invités doivent porter des habits formels de type "summer garden party : de préférence colorés et d\'inspiration estivale. Pas de chaussures à bouts carrés, c\'est interdit',
            'event-date': '23 Juillet',
            'event-e1-header': 'Boisson de bienvenue',
            'event-e1-desc': 'Svp arrivez à 3:30 PM ou avant, un stationement sera disponible sur place. ',
            'event-e2-header': 'Cérémonie de Mariage ',
            'event-e2-desc': 'CThis is the official ceremony where vows and rings will be exchanged.',
            'event-e3-header': 'Garden Reception ',
            'event-e3-desc': 'Following the ceremony, we will have a small reception.',
            'event-e4-header': 'Dinner ',
            'event-e4-desc': 'Sit down dinner at the tables in the garden if weather permits - location to be determined, either on site or at a restaurant nearby',
